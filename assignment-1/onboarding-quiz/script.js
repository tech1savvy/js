...
const questions = [
    ...
    },
    {
        ...
        options: ["Fully remote", "Hybrid model", "In-office only", "Depends on the team"],
        correctAnswer: 1,
        explanation: "TechNova offers a hybrid work model, balancing in-office collaboration with remote flexibility."
    },
    {
        question: "Which department is responsible for handling IT support requests?",
        options: ["Human Resources", "Operations", "Information Technology", "Finance"],
        correctAnswer: 2,
        explanation: "The Information Technology (IT) department handles all IT support requests."
    },
    {
        question: "What is the company's mission?",
        options: ["To be the most profitable company", "To innovate for a better future", "To provide the cheapest solutions", "To expand to every continent"],
        correctAnswer: 1,
        explanation: "TechNova's mission is to innovate for a better future, creating value for our clients and society."
    }
];
